...
const AwaitingReception = ({ data, ...props }) => {
        ...
        <Card maxW="sm">
            <CardBody>
                <Stack mt="2" spacing="2">
                    ...
                    <div className="flex">
                        <Text className="w-2/5" color="blue.600" fontSize="md">
                            Ngày tạo:
                        </Text>
                        <Text color="blue.600" fontWeight="500" fontSize="md">
                            01/12/2023
                        </Text>
                    </div>
                    <div className="flex">
                                ...
                                <label
                                    ...
                                    onClick={() => {
                                        if (item.value == selectedReason) {
                                            console.log("Dô 2", selectedReason);
                                            setSelectedReason(null);
                                        }
                                    }}
                                >
