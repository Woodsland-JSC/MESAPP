...
function CheckCard(props) {
    ...
    return (
        <div className="bg-[#F7FDFF] rounded-xl w-full h-[10.5rem] hover:shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] hover:border-[#99b4c1] border-2 border-gray-200">
            <div className="px-4 py-3  bg-[#F1F8FB] h-[45%] rounded-t-xl  flex justify-between items-center border-b border-gray-200">
