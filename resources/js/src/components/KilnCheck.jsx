            ...
            >
                ...
                <ModalContent>
                    ...
                    <ModalFooter className="bg-white border-t-2 border-gray-200 w-full sticky bottom-0">
                        <div className=" xl:flex items-center justify-end xl:px-6 md:px-6 w-full">
                            <div className="flex xl:w-fit md:w-fit w-full items-center justify-end py-4 xl:py-0 lg:py-0 md:py-0 gap-x-3 ">
                                <button
                                    onClick={onClose}
                                    className="bg-[#17506B] text-[#FFFFFF] p-2 rounded-xl px-4 active:scale-[.95] h-fit active:duration-75 transition-all xl:w-fit md:w-fit w-full"
                                >
                                    Đóng
                                </button>
                            </div>
