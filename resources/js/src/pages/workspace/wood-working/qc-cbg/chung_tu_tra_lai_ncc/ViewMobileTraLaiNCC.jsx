const ViewMobileChungTuTraLaiNCC = ({data}) => {
    return (
        <>
                    ...
                    data.map((item, index) => (
                        <div key={index} className="bg-gray-50 border-2 border-[#84b0c5] rounded-xl p-4 mx-2 mb-3">
                            <div className="flex-col w-full">
                                ...
                                <div className="grid grid-cols-2 font-semibold mb-1">
                                    <span>Mã SAP: </span>
                                        ...
                                        <div className="relative w-full">
                                            ...
                                            <div className="p-4 py-2 rounded-xl bg-gray-200 mb-2">
                                                <div className="flex-col  ">
                                                    ...
                                                    <div className="text-[13px] truncate" title={item.suplierName}>
                                                        Tên: {item.suplierName}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex justify-end rounded-xl mb-2">
                                                {/* <div>
                                                    <button
                                                        onClick={() => navigate(`/workspace/goods-management/qc-cbg/${item.sapId}`)}
                                                        type="button"
...
export default ViewMobileChungTuTraLaiNCC;