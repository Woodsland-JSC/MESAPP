...
const progressOptions = [
    { value: "SC", label: "Sơ chế" },
    { value: "TC-DG", label: "Tinh chế - Đóng gói" },
];
...
const FinishedGoodsReceipt = () => {
    ...
    const getAllAssemblyDiagrams = async (id) => {
        setIsAssemblyDiagramsLoading(true);
        try {
            const res = await domesticApi.getAllAssemblyDiagrams();
            const assemblyDiagramOptions =
                res.map((item) => ({
                    value: item.MASD,
                    label: item.MASD,
                })) || [];

            setAssemblyDiagramList(assemblyDiagramOptions);
            console.log(assemblyDiagramOptions);
            setIsAssemblyDiagramsLoading(false);
        } catch (error) {
            console.error(error);
            toast.error("Lỗi khi lấy dữ liệu");
            setIsAssemblyDiagramsLoading(false);
                                                                    ...
                                                                    (
                                                                        ...
                                                                        return (
                                                                            <Checkbox
                                                                                ...
                                                                                className={`p-2 py-3 pl-4 rounded-lg w-full font-medium ${
                                                                                    isChecked
