...
function FinishedPackagingReceipt() {
    ...
    useEffect(() => {
        ...
        document.title = "Woodsland - Nhập sản lượng đóng gói nội địa";
        return () => {
                                ...
                                <div className="flex flex-col gap-4">
                                    {loadingData ? (
                                        ...
                                        searchResults.map((item, index) => (
                                            // Đổi ID
                                            <DomesticOutputCard key={index} detailsData={item} type="DG" />
                                        ))
                                    ) : isFirstTime ? (
...
export default FinishedPackagingReceipt;
